...
<div id="car-list" class="car-container">
    <div class="car-card">
        <img src="bm2.jpg" alt="BMW M2">
        <h4>BMW M2</h4>
        <p>Price: Rs 200,00,000</p>
        <button class="button book-btn" data-car="BMW M2" data-price="2500000" data-image="bm2.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="bm5.jpg" alt="TATA Harrier">
        <h4>BMW M5</h4>
        <p>Price: Rs 250,00,000</p>
        <button class="button book-btn" data-car="BMW M5" data-price="2500000" data-image="bm5.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="bm520.jpg" alt="BMW M520">
        <h4>BMW M520</h4>
        <p>Price: Rs 12,00,000</p>
        <button class="button book-btn" data-car="BMW M520" data-price="1200000" data-image="bm520.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="bmi6.jpg" alt="BMW I6">
        <h4>BMW I6</h4>
        <p>Price: Rs 30,00,000</p>
        <button class="button book-btn" data-car="BMW I6" data-price="3000000" data-image="bmi6.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="bmxm.jpg" alt="BMW XM">
        <h4>BMW XM</h4>
        <p>Price: Rs 10,00,000</p>
        <button class="button book-btn" data-car="BMW XM" data-price="1000000" data-image="bmxm.jpg">Book</button>
    </div>
</div>
