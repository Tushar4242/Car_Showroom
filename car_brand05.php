...
<div id="car-list" class="car-container">
    <div class="car-card">
        <img src="GWagon.jpg" alt="Benz GWagon">
        <h4>Benz GWagon</h4>
        <p>Price: Rs 500,00,000</p>
        <button class="button book-btn" data-car="Benz GWagon" data-price="50000000" data-image="GWagon.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="GLE350.jpg" alt="Benz GLE350">
        <h4>Benz GWagon</h4>
        <p>Price: Rs 7,00,000</p>
        <button class="button book-btn" data-car="Benz GLE350" data-price="700000" data-image="GLE350.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="350.jpg" alt="Benz 350">
        <h4>Benz 350</h4>
        <p>Price: Rs 18,00,000</p>
        <button class="button book-btn" data-car="Benz 350" data-price="1800000" data-image="350.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="63.jpg" alt="Benz 63">
        <h4>Benz 63</h4>
        <p>Price: Rs 13,00,000</p>
        <button class="button book-btn" data-car="Benz 63" data-price="1300000" data-image="63.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="s.jpg" alt="BMW S">
        <h4>Benz S</h4>
        <p>Price: Rs 10,50,000</p>
        <button class="button book-btn" data-car="BMW S" data-price="1050000" data-image="s.jpg">Book</button>
    </div>
</div>
