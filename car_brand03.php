...
<div id="car-list" class="car-container">
    <div class="car-card">
        <img src="curvv.webp" alt="Curvvv">
        <h4>TATA Curvv</h4>
        <p>Price: Rs 25,00,000</p>
        <button class="button book-btn" data-car="TATA Curvv" data-price="2500000" data-image="curvv.webp">Book</button>
    </div>
    <div class="car-card">
        <img src="harrier.webp" alt="TATA Harrier">
        <h4>TATA Harrier</h4>
        <p>Price: Rs 25,00,000</p>
        <button class="button book-btn" data-car="TATA Harrier" data-price="2500000" data-image="harrier.webp">Book</button>
    </div>
    <div class="car-card">
        <img src="Nexon.jpg" alt="TATA NEXON">
        <h4>TATA NEXON</h4>
        <p>Price: Rs 12,00,000</p>
        <button class="button book-btn" data-car="TATA NEXON" data-price="1200000" data-image="Nexon.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="Safari.jpg" alt="TATA Safarir">
        <h4>TATA Safarir</h4>
        <p>Price: Rs 30,00,000</p>
        <button class="button book-btn" data-car="TATA Safarir" data-price="3000000" data-image="Safari.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="Altorz.webp" alt="TATA ALtroz">
        <h4>TATA ALtroz</h4>
        <p>Price: Rs 10,00,000</p>
        <button class="button book-btn" data-car="TATA ALtroz" data-price="1000000" data-image="Altorz.webp">Book</button>
    </div>
</div>
