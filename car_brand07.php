...
<div id="car-list" class="car-container">
    <div class="car-card">
        <img src="toyota1.jpg" alt="Toyota Fortuner">
        <h4>Toyota Fortuner</h4>
        <p>Price: Rs 45,00,000</p>
        <button class="button book-btn" data-car="Toyota Fortuner" data-price="4500000" data-image="toyota1.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="toyota2.jpg" alt="Toyota Hyryder">
        <h4>Toyota Hyryder</h4>
        <p>Price: Rs 12,00,000</p>
        <button class="button book-btn" data-car="Toyota Hyryder" data-price="1200000" data-image="toyota2.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="toyota3.jpg" alt="Toyota Innova">
        <h4>Toyota Innova</h4>
        <p>Price: Rs 21,00,000</p>
        <button class="button book-btn" data-car="Toyota Innova" data-price="2100000" data-image="toyota3.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="toyota4.jpg" alt="Toyota LC">
        <h4>Toyota LC</h4>
        <p>Price: Rs 1,00,00,000</p>
        <button class="button book-btn" data-car="Toyota LC" data-price="10000000" data-image="toyota4.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="toyota5.jpg" alt="Toyota Camery">
        <h4>Toyota Camery</h4>
        <p>Price: Rs 43,00,000</p>
        <button class="button book-btn" data-car="Toyota Camery" data-price="4300000" data-image="toyota5.jpg">Book</button>
    </div>
</div>
