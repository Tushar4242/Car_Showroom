...
<div id="car-list" class="car-container">
    <div class="car-card">
        <img src="XC90.jpg" alt="Volvo XC90">
        <h4>Volvo XC90</h4>
        <p>Price: Rs 72,00,000</p>
        <button class="button book-btn" data-car="Volvo XC90" data-price="7200000" data-image="XC90.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="S60.jpg" alt="Volvo S60">
        <h4>Volvo S60</h4>
        <p>Price: Rs 56,00,000</p>
        <button class="button book-btn" data-car="Volvo S60" data-price="5600000" data-image="S60.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="S90.jpg" alt="Volvo S90">
        <h4>Volvo S90</h4>
        <p>Price: Rs 75,00,000</p>
        <button class="button book-btn" data-car="Volvo S90" data-price="7500000" data-image="S90.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="V40.jpg" alt="Volvo V40">
        <h4>Volvo V40</h4>
        <p>Price: Rs 91,00,000</p>
        <button class="button book-btn" data-car="Volvo V40" data-price="9100000" data-image="V40.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="10.jpg" alt="Volvo 10">
        <h4>Volvo 10</h4>
        <p>Price: Rs 85,00,000</p>
        <button class="button book-btn" data-car="Volvo 10" data-price="8500000" data-image="10.jpg">Book</button>
    </div>
</div>
