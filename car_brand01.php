...
<div id="car-list" class="car-container">
    <div class="car-card">
        <img src="suzuki1.jpg" alt="Suzuki Brezza">
        <h4>Suzuki Brezza</h4>
        <p>Price: Rs 12,00,000</p>
        <button class="button book-btn" data-car="Suzuki Brezza" data-price="1200000" data-image="suzuki1.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="suzuki2.jpg" alt="Suzuki GV">
        <h4>Suzuki GV</h4>
        <p>Price: Rs 15,00,000</p>
        <button class="button book-btn" data-car="Suzuki GV" data-price="1500000" data-image="suzuki2.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="suzuki3.jpg" alt="Suzuki Dzire">
        <h4>Suzuki Dzire</h4>
        <p>Price: Rs 12,00,000</p>
        <button class="button book-btn" data-car="Suzuki Dzire" data-price="1200000" data-image="suzuki3.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="suzuki4.jpg" alt="Suzuki Swift">
        <h4>Suzuki Swift</h4>
        <p>Price: Rs 10,00,000</p>
        <button class="button book-btn" data-car="Suzuki Swift" data-price="1000000" data-image="suzuki4.jpg">Book</button>
    </div>
    <div class="car-card">
        <img src="suzuki5.jpg" alt="Suzuki Wagnar">
        <h4>Suzuki Wagnar</h4>
        <p>Price: Rs 10,00,000</p>
        <button class="button book-btn" data-car="Suzuki Wagnar" data-price="1000000" data-image="suzuki5.jpg">Book</button>
    </div>
</div>
